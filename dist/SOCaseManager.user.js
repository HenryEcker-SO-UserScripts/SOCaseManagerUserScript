...
(function() {
    ...
    const getAnswerIdsOnPage = () => new Set($(".s-post-summary").map(((i, e) => Number(e.getAttribute("data-post-id")))).toArray());
    const setIntersection = (a, b) => new Set([ ...a ].filter((i => b.has(i))));
