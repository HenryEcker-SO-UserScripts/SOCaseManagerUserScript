    ...
    $('body')
        .append(
            ...
            $(`<aside class="s-modal" id="${authModalId}" role="dialog" aria-labelledby="${authModalId}-modal-title" aria-describedby="${authModalId}-modal-description" aria-hidden="false" data-controller="s-modal" data-s-modal-target="modal"></aside>`)
                .append(
                    // Modal
                    $('<div class="s-modal--dialog" role="document"></div>')
                        .append(
                            // Modal Header
                        ...
                        .append(
                            ...
                            $('<ol></ol>')
                                ...
                                .append(`<li><label for="${authModalId}-input" class="mr6">Access Token:</label><input style="width:225px" id="${authModalId}-input"/></li>`)
                        )
                        .append(
                            // Button Controls
                            $('<div class="d-flex g8 gsx s-modal--footer"></div>')
                                .append(submitButton)
